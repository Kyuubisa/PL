...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PL.Authentication_users, PL", Authentication_users.class, __md_methods);
	}


	public Authentication_users ()
	{
		super ();
		if (getClass () == Authentication_users.class)
			mono.android.TypeManager.Activate ("PL.Authentication_users, PL", "", this, new java.lang.Object[] {  });
	}
